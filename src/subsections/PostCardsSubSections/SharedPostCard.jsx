...
/**
 * SharedPostCard Section
 * ------------------------------------------------------------------
 * Parent Section: PostCard
 *
 * Displays the preview of an original post when another post is shared.
 * Includes:
 *  - Original author’s name and timestamp
 *  - Original post content
 *  - Clean bordered layout for visual distinction
 * ------------------------------------------------------------------
 */
const SharedPostCard = ({ post }) => {
  ...
  return (
    <div className="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6 text-gray-700 hover:bg-gray-100 transition-all duration-200">
      {/* ------------------------------------------------------------
           Header — Original Author and Timestamp
         ------------------------------------------------------------ */}
