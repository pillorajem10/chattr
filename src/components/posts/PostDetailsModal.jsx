...
const PostDetailsModal = ({ post, comments, open, onClose, onCommentInputChange, onSubmitComment, commentFormValues }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden relative">
        ...
        {/* Comments (scrollable area only) */}
        <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
          <h3 className="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
            <MessageCircle size={16} /> Comments
          </h3>
          {comments && comments.length > 0 ? (
            <div className="space-y-3 pb-16"> {/* extra space for input overlap */}
